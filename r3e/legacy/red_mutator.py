"""Legacy constrained red mutator retained for historical reproduction.

This module is non-authoritative and must not be used by Whole-Policy
Evolution formal runtime.
...
from r3e.microsurgeon_flow.backend_eco_oneshot import call_llm
from r3e.semantic_repair_bench.functional_repair import apply_block
from r3e.semantic_repair_bench.oracle_gate import judge


LEGACY_ONLY = True
DEPRECATED_REPLACEMENT = "r3e.red.generator"
...
def _main() -> None:
    import argparse
    from r3e.semantic_repair_bench.cirfix_adapter import parse_project
